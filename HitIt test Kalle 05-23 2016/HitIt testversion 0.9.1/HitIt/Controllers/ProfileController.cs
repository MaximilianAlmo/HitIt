...
namespace HitIt.Controllers
{
    public class ProfileController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="id,profileName,dateOfBirth,city,country,languages,rating,about,picture,teaser,UserName,picturePath")] profile profile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="id,profileName,dateOfBirth,city,country,languages,rating,about,picture,teaser,UserName,picturePath")] profile profile)
        {
            if (ModelState.IsValid)
            {
